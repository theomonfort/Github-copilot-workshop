...
icon: /icons/enterprise-bank.png
color: magenta
accent:
...
![Data hosting 選択画面](/playbook/img/enterprise-data-hosting.png)
...
![EMU 管理者の Overview 画面](/playbook/img/enterprise-emu-admin-overview.png)
...
![Provisioning 設定画面](/playbook/img/entra-provisioning-config.png)
...
![IdP グループの同期設定](/playbook/img/enterprise-idp-group-sync.png)
