...
flowchart LR
  ...
  Agent -->|コンテキスト| LLM["<b>LLM</b><div class='llm-row'><img src='/llm-openai.png' alt=''/><img src='/llm-anthropic.svg' alt=''/><img src='/llm-gemini.png' alt=''/><img src='/llm-grok.png' alt=''/><img class='ms-ico' src='/llm-microsoft.svg' alt=''/></div>"]
  LLM -->|次の一手| Agent
